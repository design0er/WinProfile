...
//hok
//plugins.options["hok.follow_link_nextpattern"] = [
//    "下页",
//    "下一页",
//    "后页",
//    "后一页",
...
//	"前一*"
//];
//plugins.options["hok.follow_link_nextpattern"] = "Next"
//plugins.options["hok.follow_link_prevpattern"] = "Previous"
...
key.setViewKey(['g','m'], function (ev, arg) {
...
//tab nav
key.setViewKey([['d'],['M-.']], function (ev) {
                getBrowser().mTabContainer.advanceSelectedTab(1, true);
            }, 'Select next tab', false);

key.setViewKey([['a'],['M-,']], function (ev) {
                getBrowser().mTabContainer.advanceSelectedTab(-1, true);
            }, 'Select previous tab', false);
...
plugins.options["kkk.sites"] = ["^https?://([0-9a-zA-Z]+\\.)?zhihu\\.com/"];
