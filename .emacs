...
(cl-case system-type
  ...
  ('gnu/linux (load-file (concat (getenv "HOME") "winnt.el")))
  ('darwin (load-file (concat (getenv "HOME") "winnt.el"))))
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(writeroom-mode objed flymd sr-speedbar htmlize dracula-theme avy counsel ivy markdown-mode))))
(custom-set-faces
